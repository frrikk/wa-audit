...
const supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVwaHZrenBtc3Bmb2p4ZnZreGN1Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3MTAzMzAyMDIsImV4cCI6MjAyNTkwNjIwMn0.StG0oFUUOKYxRp6LZWZ5fXJWXe7dDlJtLZ4CHPxwsvU"; // Use your actual Supabase key here
...
// const supabaseUrl = "https://uphvkzpmspfojxfvkxcu.supabase.co";
// const supabaseKey =
//   "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVwaHZrenBtc3Bmb2p4ZnZreGN1Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3MTAzMzAyMDIsImV4cCI6MjAyNTkwNjIwMn0.StG0oFUUOKYxRp6LZWZ5fXJWXe7dDlJtLZ4CHPxwsvU";
// const supabase = createClient(supabaseUrl, supabaseKey);
//
// async function runLighthouseAndSaveScores(url) {
